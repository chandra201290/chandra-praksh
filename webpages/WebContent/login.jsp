...
<body>
	<div class="container">
		...
		<form class="form-horizontal loginform" action="test">
			<br>
			...
			<div class="form-group">
				<div class="col-md-10">
					...
					<div class="col-md-offset-2 col-md-2">
						<button type="submit" id="login" class="btn btn-default textcolour" align="right" class="textcolour">LOGIN <span class="glyphicon glyphicon-play"></span></button>
					</div>
				</div>
			</div>
		</form>
